...
def test():
    poor_bob = ri.StudentWithOutStrAndEq(
        'Bob', 'Poor', '12', [10, 9, 9, 8, 10])
    poor_bob_twin = ri.StudentWithOutStrAndEq(
        'Bob', 'Poor', '12', [10, 9, 9, 8, 10])
    ...
    chris = rie.Student(
        'Christian', 'Markella', '123', [100, 99, 99, 98, 100])
    chris_twin = rie.Student(
        'Christian', 'Markella', '123', [100, 99, 99, 98, 100])
    print(f'chris:-->     {chris}')
    ...
    dataclass_bob = di.Student(
        'Bob', 'Dataclass', '12', [101, 99, 99, 98, 101])
    dataclass_bob_twin = di.Student(
        'Bob', 'Dataclass', '12', [101, 99, 99, 98, 101])
    ...
    print(f'dataclass_bob == dataclass_bob_twin: '
          f'{dataclass_bob == dataclass_bob_twin}')
    print(f'dataclass_bob is dataclass_bob_twin: '
          f'{dataclass_bob is dataclass_bob_twin}')
